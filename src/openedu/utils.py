...
from src.openedu.ids import SequentialBlockID, VerticalBlockID, CourseID


def parse_page_url(url: str)->tuple[CourseID, SequentialBlockID, VerticalBlockID]:
    ...
    course_id = CourseID.parse(course_id_r.group(1))
